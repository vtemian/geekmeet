import os
# Django settings for geekmeet project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'geekmeet',                      # Or path to database file if using sqlite3.
        'USER': 'geekmeet',                      # Not used with sqlite3.
        'PASSWORD': 'geekmeet',                  # Not used with sqlite3.
...
STATIC_ROOT = '/home/geekmeetstatic'
...
SECRET_KEY = '5y8exw+6yt2t5ll=hl9s%s45ivjqx0apolebceqe+*5iu(+y3v'
